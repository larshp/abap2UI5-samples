...
CLASS Z2UI5_CL_DEMO_APP_072 IMPLEMENTATION.
  ...
  METHOD Z2UI5_set_data.
    ...
    temp4-state_price = `Success`.
    temp4-rating = '5'.
    temp4-state_measure = `Information`.
    INSERT temp4 INTO TABLE temp3.
    mt_table = temp3.
    ...
    DATA temp6 TYPE i.
    temp6 = 0.
    DATA temp2 LIKE LINE OF mt_table.
    LOOP AT mt_table INTO temp2 WHERE measure > 0 AND measure <= 100.
      temp6 = temp6 + 1.
    ENDLOOP.
    temp1 = temp6.
    lv_cnt_pos = temp1.
    lv_cnt_heavy = REDUCE i( INIT temp6 = 0 FOR wa IN mt_table WHERE ( measure > 100 AND measure <= 500 ) NEXT temp6 = temp6 + 1 ).
